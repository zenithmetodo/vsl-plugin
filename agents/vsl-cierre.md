...
- **[knowledge/19-copy-en-la-vsl.md](../knowledge/19-copy-en-la-vsl.md)** — ⭐ Mapa pieza → paso (copy). **Si conoces el nivel de consciencia y la sofisticación del mercado**, afina la **oferta**, el **pitch** y la **urgencia** según el mapa. **Si no, construye con normalidad** — el input es OPCIONAL.
