...
- **[${CLAUDE_PLUGIN_ROOT}/knowledge/15-sistema-optimizacion.md](${CLAUDE_PLUGIN_ROOT}/knowledge/15-sistema-optimizacion.md)** — Cuaderno de tests, Test Eterno, conversión como única religión.
